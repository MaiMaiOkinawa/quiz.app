const quizData = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1501820488136-72669149e0d4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
    a: "earth",
    b: "country",
    c: "world",
    d: "train",
  ...
  },
  {
    question: "Pick the right word!",
    image:
      "https://images.unsplash.com/photo-1504542982118-59308b40fe0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
    a: "earth",
    b: "country",
    c: "world",
    d: "train",
  ...
  },
  {
    question: "Pick the right word!",
    image:
      "https://images.unsplash.com/photo-1585617205014-f3faf04343c2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
    a: "earth",
    b: "country",
    c: "world",
    d: "train",
...
submitBtn.addEventListener("click", () => {
  ...
  if (answer) {
    ...
    if (currentQuiz < quizData.length) {
      ...
      quiz.innerHTML = `
        <h1>You answered correctly at ${score}/${quizData.length} questions correctly</h1>
